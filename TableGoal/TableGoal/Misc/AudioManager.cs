...
namespace TableGoal
{
    ...
    public class AudioManager : GameComponent
    {
        ...
        bool playbackAlreadyStarted = false;

        public bool PlaybackAlreadyStarted
        {
            get { return playbackAlreadyStarted; }
        }
        ...
        {
            LoadSound("pencil_select", "selected");
            LoadSound("clock", "clock");
            LoadSound("kick", "kick");
            LoadSound("whistle", "whistle");
            LoadSound("endWhistle", "end");
            LoadSound("goal", "goal");
        }
        ...
        {
            if (GameVariables.Instance.SoundsOn)
                if (MediaPlayer.GameHasControl && MediaPlayer.State != MediaState.Paused)
        ...
        {
            if (GameVariables.Instance.MusicOn)
                if (MediaPlayer.GameHasControl && MediaPlayer.State != MediaState.Paused)
                    ...
                    if (audioManager.musicBank.ContainsKey(musicSoundName))
                    {
                        ...
                        audioManager.playbackAlreadyStarted = true;
                    }
        }
        ...
        public static void StopMusic()
        {
            if (MediaPlayer.GameHasControl && MediaPlayer.State != MediaState.Paused)
                ...
                {
                    MediaPlayer.Stop();
                    audioManager.playbackAlreadyStarted = false;
                }
        }
